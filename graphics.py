...
testgrid=board.grid(mapFeatures.mountains,mapFeatures.oceans)
...
p1=minTotalAI.minTotalAI(testgrid,mapFeatures.cities)
...
while running:
    ...
    for color in mapFeatures.cities.keys():
        for city in mapFeatures.cities[color].values():
